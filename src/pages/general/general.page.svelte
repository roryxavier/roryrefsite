	...
	<ResponsiveContainer>
		<div class="Section">
			...
			<table class="w-full table-fixed" style="border-bottom: 1px solid indigo">
				...
				{#each FURSONA_RORY_CHRIS.generalBioTableKVPair as property}
			...
			<div class="Section">
				...
				<div id="personality-text" class="flex flex-col space-y-3 text-justify text-lg">
					<p>
						...
						with others and understand their feelings, and goes out of his way to bring joy and
					...
					<p>
						...
						personality makes people feel at ease. Whether it's through his words, actions, or
						simply his infectious smile, Rory never fails to bring happiness to those.
					</p>
					...
					<p>
						...
						truly a friend to cherish and a source of constant inspiration to all those who know
						him.
					</p>
				</div>
				...
				<div id="hobbies-text" class="flex flex-col space-y-3 text-justify text-lg">
					<p>
						...
						spent countless hours learning the inner workings of these machines. His inquisitive
						nature, however, got him into trouble when he was younger, as he often opened and
						destroyed countless PCs, much to the annoyance of his parents. Despite these setbacks,
						Rory's focus was always on programming, and he has a deep desire to build something
						great one day and show the world his creations.
					</p>
					<p>
						Aside from his love for computers, Rory has a passion for travel. Before the global
						pandemic, his parents would take him on trips to different countries, which sparked his
						interest in seeing more of the world. He dreams of one day traveling with a companion
						and has a natural love for planning, which is a byproduct of his love for travel. He
						wants to make sure everything is well-prepared and that nothing goes wrong during his
						adventures.
					</p>
					<p>
						Cooking is another passion of Rory's. He loves experimenting with new dishes and trying
						out new recipes. His favorite food is Chicken Fried Rice, but he also has a fondness for
						pizza, pasta, smash burgers, and Mac & Cheese. He has a fur friend who is a good cook
						and has been helping him improve his own cooking skills. Despite the occasional
						arguments and frustration, this friend has been a constant source of inspiration and
						encouragement for Rory. One food he dislikes is fish, and he will go out of his way to
						avoid it.
					</p>
					...
					<div id="food-drink" class="flex flex-col space-y-3 text-justify text-lg">
						...
						<p>
							...
							noodles or rice being one of his favorites. He has a special affinity for
							western-style cuisine, such as Mac and Cheese, burgers, chicken chops, and lasagna. He
							has even learned to make these dishes from one of his foodie friends. In the evening.
						</p>
						<p>
							He satisfies his sweet tooth with a glass of chocolate milk, rounding off his day with
